  ...
  (t.raty = {
    ...
    (t.fn.raty = function (e) {
      return this.each(function () {
        return new t.raty.Raty(this, e)._create();
      });
    }),
    (t.raty.Raty =
      (((e = function (e, i) {
        (this.element = e),
          (this.self = t(e)),
          (this.opt = t.extend(!0, {}, t.raty, i, this.self.data()));
      }).prototype = {
        _create: function () {
            ...
            for (
              ...
              for (var s = 0; s < t; s++) {
                var o = i[s],
                  n = i[i.length - 1];
                void 0 === n && (n = null),
                  (this.opt.hints[e][s] = void 0 === o ? n : o);
              }
            }
        },
        ...
        _apply: function (t) {
          this._fill(t),
            t && (t > 0 && this.scoreField.val(t), this._roundStars(t));
        },
        _attributesForIndex: function (t) {
          var e = this._nameForIndex(t),
            i = { alt: t, src: this.opt.path + this.opt[e] };
          return (
            "img" !== this.opt.starType &&
              (i = { "data-alt": t, class: this.opt[e] }),
            (i.title = this._getHint(t)),
            i
          );
        },
        ...
        _bindClick: function () {
          var e = this;
          this.stars.on("click.raty", function (i) {
            if (!e.self.data("readonly")) {
              var s = !0,
                o =
                  e.opt.half || e.opt.precision
                    ? e.self.data("score")
                    : this.alt || t(this).data("alt");
              e.opt.half && !e.opt.precision && (o = e._roundHalfScore(o)),
                e.opt.click && (s = e.opt.click.call(e.element, +o, i)),
                (s || void 0 === s) && e._apply(+o);
            }
          });
        },
        ...
        _bindOutCancel: function () {
          var t = this;
          this.cancelButton.on("mouseleave.raty", function (e) {
            var i = t.opt.cancelOff;
            if (
              ("img" !== t.opt.starType && (i = t.opt.cancelClass + " " + i),
              t._setIcon(this, i),
              t.opt.mouseout)
            ) {
              var s = +t.scoreField.val() || void 0;
              t.opt.mouseout.call(t.element, s, e);
            }
          });
        },
        _bindOver: function () {
          ...
          this.stars.on(e, function (e) {
            var i = t._getScoreByPosition(e, this);
            t._fill(i),
              t.opt.half &&
                (t._roundStars(i, e),
                t._setTitle(i, e),
                t.self.data("score", i)),
              t._target(i, e),
              t.opt.mouseover && t.opt.mouseover.call(t.element, i, e);
          });
        },
        _bindOverCancel: function () {
          var t = this;
          this.cancelButton.on("mouseover.raty", function (e) {
            if (!t.self.data("readonly")) {
              var i = t.opt.path + t.opt.starOff,
                s = t.opt.cancelOn;
              "img" === t.opt.starType
                ? t.stars.attr("src", i)
                : ((s = t.opt.cancelClass + " " + s), t.stars.attr("class", i)),
                t._setIcon(this, s),
                t._target(null, e),
                t.opt.mouseover && t.opt.mouseover.call(t.element, null);
            }
          });
        },
        ...
        _createCancel: function () {
          ...
          "img" === this.opt.starType
            ? i.attr({ src: e, alt: "x" })
            : i.attr("data-alt", "x").addClass(e),
            "left" === this.opt.cancelPlace
              ? this.self.prepend("&#160;").prepend(i)
              : this.self.append("&#160;").append(i),
            (this.cancelButton = i);
        },
        _createScore: function () {
          var e = t(this.opt.targetScore);
          this.scoreField = e.length ? e : this._buildScoreField();
        },
        _createStars: function () {
          for (var e = 1; e <= this.opt.number; e++) {
            var i = this._attributesForIndex(e);
            t("<" + this.opt.starType + " />", i).appendTo(this.element),
              this.opt.space &&
                e < this.opt.number &&
                this.self.append("&#160;");
          }
        ...
        _executeCallbacks: function () {
          for (
            ...
            if ("function" == typeof this.opt[t[e]]) {
              var i = this.opt[t[e]].call(this.element);
              i ? (this.opt[t[e]] = i) : delete this.opt[t[e]];
            }
        },
        _fill: function (t) {
          var e = 0;
          ...
          for (var i = 1; i <= this.stars.length; i++) {
            ...
            if (this.opt.iconRange && this.opt.iconRange.length > e) {
              ...
              (s = this._getRangeIcon(a, n)),
                i <= a.range && this._setIcon(o, s),
                i === a.range && e++;
            } else
              (s = this.opt[n ? "starOn" : "starOff"]), this._setIcon(o, s);
          }
        },
        ...
        _getScoreByPosition: function (e, i) {
          var s = parseInt(i.alt || i.getAttribute("data-alt"), 10);
          if (this.opt.half) {
            var o = this._getWidth();
            s = s - 1 + parseFloat((e.pageX - t(i).offset().left) / o);
          }
          return s;
        },
        _getHint: function (t, e) {
          if (0 !== t && !t) return this.opt.noRatedMsg;
          var i = this._getDecimal(t, 1),
            s = this.opt.hints[(Math.ceil(t) || 1) - 1],
            o = s,
            n = !e || this.isMove;
          return (
            this.opt.precision
        ...
        _roundHalfScore: function (t) {
          var e = parseInt(t, 10),
            i = this._getDecimal(t, 1);
          return 0 !== i && (i = i > 5 ? 1 : 0.5), e + i;
        },
        _roundStars: function (t, e) {
          var i = this._starName(t, e);
          if (i) {
            var s = this.opt[i],
        ...
        _setTitle: function (t, e) {
          if (t) {
            ...
            this.stars[i - 1].title = this._getHint(t, e);
          }
        },
        _starName: function (t, e) {
          ...
          return e || this.isMove
            ? i > 0.5
              ? "starOn"
              : "starHalf"
            : i <= this.opt.round.down
            ? void 0
            : this.opt.halfShow && i < this.opt.round.up
            ? "starHalf"
            : i < this.opt.round.full
            ? "starOff"
            : "starOn";
        },
        _target: function (e, i) {
          if (this.opt.target) {
            ...
            s.length || this._error("Target selector invalid or missing!");
            var o = i && "mouseover" === i.type;
            if (void 0 === e) e = this.opt.targetText;
            else if (null === e)
              e = o ? this.opt.cancelHint : this.opt.targetText;
            else {
              "hint" === this.opt.targetType
                ? (e = this._getHint(e, i))
                : this.opt.precision && (e = parseFloat(e).toFixed(1));
              var n = i && "mousemove" === i.type;
              o || n || this.opt.targetKeep || (e = this.opt.targetText);
            }
            this._setTarget(s, e);
          }
        },
        ...
        click: function (e) {
          !0 !== this.self.data("readonly") &&
            ((e = this._adjustedScore(e)),
            this._apply(e),
            this.opt.click &&
              this.opt.click.call(this.element, e, t.Event("click")),
            this._target(e));
        },
        getScore: function () {
          var t,
            e = [];
          return (
            e.push((t = this.scoreField.val()) ? +t : void 0),
            e.length > 1 ? e : e[0]
          );
        },
        move: function (e) {
          var i = parseInt(e, 10),
            s = this._getDecimal(e, 1);
          i >= this.opt.number && ((i = this.opt.number - 1), (s = 10));
          var o = this._getWidth(),
            n = t(this.stars[i]),
            a = n.offset().left + (o / 10) * s,
            r = t.Event("mousemove", { pageX: a });
          (this.isMove = !0), n.trigger(r), (this.isMove = !1);
        },
        readOnly: function (t) {
